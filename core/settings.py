...
# LTI apps are typically rendered in an LMS iframe.
X_FRAME_OPTIONS = 'ALLOWALL'

# Comma-separated list of hostnames/IPs, e.g. "localhost,127.0.0.1"
if os.getenv('ALLOWED_HOSTS'):
    ALLOWED_HOSTS = [h.strip() for h in os.getenv('ALLOWED_HOSTS', '').split(',') if h.strip()]

# Consumer key -> shared secret mapping. Example:
# export LTI_CONSUMERS="moodle-key:moodle-secret,other-key:other-secret"
LTI_CONSUMERS = {}
_lti_consumers_env = os.getenv('LTI_CONSUMERS', '')
for pair in _lti_consumers_env.split(','):
    if ':' not in pair:
        continue
